...
export function GoogleIcon({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden>
      ...
      <path
        fill="#34A853"
        d="M12 24c3.24 0 5.95-1.08 7.93-2.91l-3.86-2.97c-1.07.72-2.44 1.15-4.07 1.15-3.13 0-5.78-2.11-6.73-4.96H1.29v3.09C3.26 21.3 7.31 24 12 24z"
      />
      <path
        fill="#FBBC05"
        d="M5.27 14.31A7.2 7.2 0 014.9 12c0-.8.14-1.58.37-2.31V6.6H1.29A11.99 11.99 0 000 12c0 1.94.46 3.77 1.29 5.4l3.98-3.09z"
      />
      <path
        fill="#EA4335"
...
export function SignupCard({
  ...
  return (
    <div
      className="absolute"
      style={{ left: "calc(8.33% + 79px)", top: 169, width: 434, height: 578 }}
    >
      {/* Full logo (outside the bordered card) */}
      <div style={{ width: 238, height: 36 }}>
        <img src="/rsa-logo.svg" alt="RightStepAhead" className="h-9" />
      </div>

      {/* Bordered card */}
      <div
        className="absolute rounded-lg border"
        style={{ top: 65, left: 0, width: 434, height: 513, borderColor: "#272735" }}
      />
      ...
      <div
        ...
        style={{ left: 36, top: 262, width: 360 }}
      >
        <button
          className="flex items-center justify-center gap-3 rounded px-4 py-[10px]"
          style={{ background: "#fdfdfd" }}
        >
          <GoogleIcon />
          <span
            className="font-medium"
            style={{ color: "#515151", fontSize: 20, fontFamily: "Outfit, sans-serif", letterSpacing: "-0.16px" }}
          >
            Sign up with Google
          </span>
        </button>
        ...
        >
          ...
          <span
            className="font-medium"
            style={{ color: "#fdfdfd", fontSize: 16, fontFamily: "Outfit, sans-serif", letterSpacing: "-0.128px" }}
          >
            Sign in with Apple
          </span>
        </button>
      ...
      <p
        className="absolute italic font-medium"
        style={{
          left: 205,
          top: 399,
          color: "#b3b3b3",
      ...
      {/* Extra content between input & CTA (e.g. resend / timer) */}
      {extraBelowInput}
      ...
      <a
        href="#"
        className="absolute font-semibold text-right"
        style={{
          right: 38,
          top: 598,
          fontSize: 12,
...
export function FormInput({
  ...
  return (
    <div
      ...
      style={{
        background: "#08081a",
        borderColor: filled ? "#9c9ca3" : "#393948",
      }}
    >
      <span
        style={{
...
export function AspirationalCopy({
  ...
  return (
    <>
      ...
      {/* Little accent dashes under copy */}
      <div className="absolute flex gap-1" style={{ left: "calc(50% + 46px)", top: 686 }}>
